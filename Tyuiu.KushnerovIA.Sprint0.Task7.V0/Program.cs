...
using Tyuiu.KushnerovIA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.KushnerovIA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Кушнеров Иван Антонович | ПКТб-23-2";
            Console.WriteLine("***************************************************************************");
